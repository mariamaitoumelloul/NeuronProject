...
struct qt_meta_stringdata_InputInt_t {
    QByteArrayData data[9];
    char stringdata[59];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_InputInt_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_InputInt_t qt_meta_stringdata_InputInt = {
    {
...
QT_MOC_LITERAL(7, 49, 3),
QT_MOC_LITERAL(8, 53, 4)
    },
    "InputInt\0changed\0\0showHelp\0Input*\0"
    "reset\0setValue\0val\0help\0"
};
...
void InputInt::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (InputInt::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&InputInt::changed)) {
                *result = 0;
            }
        }
        {
            typedef void (InputInt::*_t)(Input * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&InputInt::showHelp)) {
                *result = 1;
            }
        }
    }
...
const QMetaObject InputInt::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_InputInt.data,
      qt_meta_data_InputInt,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_InputInt.stringdata))
