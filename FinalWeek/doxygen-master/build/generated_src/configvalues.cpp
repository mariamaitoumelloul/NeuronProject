...
#endif
#if USE_LIBCLANG
  m_map.insert("CLANG_COMPILATION_DATABASE_PATH",new InfoString(&ConfigValues::CLANG_COMPILATION_DATABASE_PATH));
#endif
...
#endif
#if USE_LIBCLANG
  CLANG_COMPILATION_DATABASE_PATH = ConfigImpl::instance()->getString(__FILE__,__LINE__,"CLANG_COMPILATION_DATABASE_PATH");
#endif
